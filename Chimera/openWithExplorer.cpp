...
/*
 * This function gets the name of a script folder for running multiples scripts and opens the selected script.
 * It returns the chosen parent folder of the selected file if successful, it returns "" if the user canceled.
 */
