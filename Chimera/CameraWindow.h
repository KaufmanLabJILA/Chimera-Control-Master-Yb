...
public:
	...
	void stopPlotter();
	static UINT __stdcall frameGrabberThread(void* voidPtr);
	struct frameGrabberThreadInput
	{
...
private:
	...
	bool frameGrabberThreadExitIndicator = false;
	...
	UINT frameGrabberThreadID = 1;
	//Gnuplotter plotter;
	frameGrabberThreadInput threadInput;
};
