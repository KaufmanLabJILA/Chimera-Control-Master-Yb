...
if __name__ == "__main__":
    watcher = dw.DirectoryWatcher(
        r'C:\Users\klab\Documents\Chimera-Control-Master\Chimera',
    ...
    while True:
        try:
            ...
            if action_name == 'rename' and isPyStartFile:
                ...
                # valueArray = [5,5,5,5,5,5,5,5]
                
                #get x,y and z voltages
                # Vx = valueArray[0]
                # Vy = valueArray[1]
                # Vz = valueArray[2]

                # toSendArray = [Vy+Vx+Vz, Vy-Vx+Vz, -Vy+Vx+Vz, -Vy-Vx+Vz, -Vy+Vx-Vz, -Vy-Vx-Vz, Vy+Vx-Vz, Vy-Vx-Vz]
